# This file is part of meas_extensions_aipsf.
#
...
from lsst.meas.extensions.aipsf.aipsfPsfDeterminer import AipsfPsfDeterminerConfig, AipsfPsfDeterminerTask
from lsst.meas.extensions.aipsf.aipsfPsfDeterminer import _validateGalsimInterpolant
...
class SpatialModelPsfTestCase(lsst.utils.tests.TestCase):
    ...
    def setupDeterminer(
        ...
        psfDeterminerConfig = AipsfPsfDeterminerConfig()
        ...
        self.psfDeterminer = AipsfPsfDeterminerTask(psfDeterminerConfig)
    ...
    def checkPiffDeterminer(self, **kwargs):
        ...
        logger = logging.getLogger("lsst.psfDeterminer.Aipsf")
        ...
        with self.assertLogs("lsst.psfDeterminer.Aipsf.piff", log_level) as cm:
            if kwargs.get("zerothOrderInterpNotEnoughStars", False):
                ...
                with self.assertNoLogs("lsst.psfDeterminer.Aipsf", logging.WARNING):
                    psf, cellSet = self.psfDeterminer.determinePsf(
                        self.exposure,
                        psfCandidateList,
                        metadata,
        ...
        logger = logging.getLogger("lsst.psfDeterminer.Aipsf.piff")
